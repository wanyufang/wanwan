...
//   // 遍历数组,往this.validataFuncs 添加新的验证的方法
...
//   for (let i = 0; i < this.validataFuncs.length; i++) {
//     let msg = this.validataFuncs[i]();
//     if (msg) {
//       return msg;
//     }
//   }
